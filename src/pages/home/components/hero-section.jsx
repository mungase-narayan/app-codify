...
import { ArrowRight, Badge, Clock, Eye, Lightbulb, Mic, Play, Star, Users, Zap } from "lucide-react"
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            >
              The ultimate platform for technical interviews. Real-time collaborative coding, built-in voice calls, and
              session recordings that make hiring developers seamless.
            </p>
          ...
          >
            <Card className="bg-gray-900/50 backdrop-blur-sm border-gray-700 rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-all duration-500 hover:scale-[1.02]">
              ...
              <div className="bg-gray-800/80 px-4 sm:px-6 py-4 border-b border-gray-700">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-gray-300 text-sm">interview-session.js</span>
                  </div>
              ...
              <div className="p-4 sm:p-6 font-mono text-xs sm:text-sm overflow-x-auto">
                <div className="space-y-2 min-w-max">
                  ...
                  <div className="flex animate-fadeInUp" style={{ animationDelay: "0.2s" }}>
                    <span className="text-gray-500 w-6 sm:w-8 flex-shrink-0">2</span>
                    <span className="text-gray-400 ml-4">// Interviewer typing...</span>
                    <div className="w-2 h-4 bg-blue-400 ml-2 animate-pulse"></div>
                  </div>
                  <div className="flex animate-fadeInUp" style={{ animationDelay: "0.4s" }}>
                  ...
                  <div className="flex animate-fadeInUp" style={{ animationDelay: "0.6s" }}>
                    <span className="text-gray-500 w-6 sm:w-8 flex-shrink-0">4</span>
                    <span className="text-gray-400 ml-4">// Candidate: What should I do next?</span>
                  </div>
                  <div className="flex animate-fadeInUp" style={{ animationDelay: "0.8s" }}>
            ...
            <div className="absolute -bottom-2 sm:-bottom-4 -right-2 sm:-right-4 bg-purple-600 text-white p-2 sm:p-3 rounded-lg shadow-lg animate-pulse">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs sm:text-sm font-medium">Session: 23:45</span>
              </div>
            </div>
          </div>
        </div>
